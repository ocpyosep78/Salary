<?php
/**
 * ZDetachmentAllowDivmasterFixture
 *
 */
class ZDetachmentAllowDivmasterFixture extends CakeTestFixture {
 ...
 * @var string
 */
	public $table = 'z_detachment_allow_divmaster';
 ...
 */
	public $fields = array(
		'ID' => array('type' => 'string', 'null' => false, 'default' => null, 'length' => 2, 'key' => 'primary', 'collate' => 'utf8_general_ci', 'comment' => '区分 : 区分', 'charset' => 'utf8'),
		'NAME' => array('type' => 'string', 'null' => true, 'default' => null, 'length' => 25, 'collate' => 'utf8_general_ci', 'comment' => '名称 : 名称', 'charset' => 'utf8'),
 ...
 */
	public $records = array(
		array(
			...
			'RegDate' => '2013-06-18 00:03:25',
			'RegisteredBy' => 'Lorem ip',
			'RegPgID' => 'Lorem ip',
			'UpdateDate' => '2013-06-18 00:03:25',
			'UpdateBy' => 'Lorem ip',
