<?php
/**
 * QmKanrishokuChildFixture
 *
 */
class QmKanrishokuChildFixture extends CakeTestFixture {
 ...
 * @var string
 */
	public $table = 'qm_kanrishoku_child';
 ...
 */
	public $fields = array(
		...
		'CalcBaseInfo' => array('type' => 'string', 'null' => false, 'default' => null, 'length' => 6, 'key' => 'primary', 'collate' => 'utf8_general_ci', 'comment' => '算定基礎項目', 'charset' => 'utf8'),
		...
		'indexes' => array(
			'PRIMARY' => array('column' => array('RevYM', 'SalaryTypeCD', 'SalaryTableCD', 'JobGradeCD_From', 'CalcBaseInfo'), 'unique' => 1)
		),
 ...
 */
	public $records = array(
		array(
			...
			'JobGradeCD_To' => '',
			'CalcBaseInfo' => 'Lore',
			'registered_date' => '2013-06-17 23:34:54',
			'registered_by' => 'Lorem ip',
			'updated_date' => '2013-06-17 23:34:54',
			'updated_by' => 'Lorem ip',
