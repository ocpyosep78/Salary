<?php
/**
 * QmKmKeisanStatusFixture
 *
 */
class QmKmKeisanStatusFixture extends CakeTestFixture {
 ...
 * @var string
 */
	public $table = 'qm_km_keisan_status';
 ...
 */
	public $fields = array(
		'PaidYM_EndDiligent' => array('type' => 'date', 'null' => false, 'default' => null, 'key' => 'primary', 'comment' => '期末勤勉支給年月'),
		'PaidDate' => array('type' => 'date', 'null' => true, 'default' => null, 'comment' => '期末勤勉支給年月日'),
		...
		'NecessaryAdjustDiv' => array('type' => 'string', 'null' => false, 'default' => '0', 'length' => 1, 'collate' => 'utf8_general_ci', 'comment' => '所要の調整有無区分　：0　なし　1：あり', 'charset' => 'utf8'),
		'RecordRateENDiv' => array('type' => 'string', 'null' => true, 'default' => null, 'length' => 1, 'collate' => 'utf8_general_ci', 'comment' => '成績率処理区分　：　1：勤務手当搬出額・成績率算出　2：成績率算出後処理', 'charset' => 'utf8'),
		...
		'indexes' => array(
			'PRIMARY' => array('column' => 'PaidYM_EndDiligent', 'unique' => 1)
		),
 ...
 */
	public $records = array(
		array(
			...
			'NecessaryAdjustDiv' => 'Lorem ipsum dolor sit ame',
			'RecordRateENDiv' => 'Lorem ipsum dolor sit ame',
			'CalcStatusDiv' => 'Lorem ipsum dolor sit ame',
			'registered_date' => '2013-06-17 23:35:49',
			'registered_by' => 'Lorem ip',
			'updated_date' => '2013-06-17 23:35:49',
			'updated_by' => 'Lorem ip',
