<?php
/**
 * QtMeisaiHiwariFixture
 *
 */
class QtMeisaiHiwariFixture extends CakeTestFixture {
 ...
 */
	public $fields = array(
		...
		'AnnounceSalaryTotal' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '給料　発令給（合計）'),
		'Salary' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '給料のみ'),
		'AdjustedAmount' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '調整額（幼教、清掃、指導主事）'),
		...
		'SpecificDutySalaryDays' => array('type' => 'integer', 'null' => true, 'default' => '0', 'comment' => '単価算入特勤日数'),
		'RequestedWorkingDaysOfMonth' => array('type' => 'integer', 'null' => true, 'default' => null, 'comment' => '月の要勤務日数'),
		...
		'ObjectDays' => array('type' => 'integer', 'null' => true, 'default' => null, 'comment' => '対象日数'),
		...
		'WorkingDaysOfWeek' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => '2,1', 'comment' => '週の勤務日数'),
		...
		'OtherMonth' => array('type' => 'integer', 'null' => true, 'default' => null, 'comment' => 'その他の期間の分母（ヶ月）'),
		'UnitPrcPerHour100' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '時間単価　100'),
		'UnitPrcPerHour125' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '時間単価　125'),
		'UnitPrcPerHour150' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '時間単価　150'),
		'UnitPrcPerHour135' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '時間単価　135'),
		'UnitPrcPerHour160' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '時間単価　160'),
		'UnitPrcPerHour25' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '時間単価　25'),
		'UnitPrcPerHour25_PreMonth' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '時間単価　前月25'),
		'UnitPrcPerHour175' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '時間単価　175'),
		'UnitPrcPerHour50' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '時間単価　50'),
		'UnitPrcPerHour50_PreMonth' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '時間単価　前月50'),
		'SalaryUnitPerDay' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => 10, 'comment' => '日単価（金額/日）'),
		...
		'indexes' => array(
			'PRIMARY' => array('column' => array('PaidYM', 'EmpNo', 'PaidDiv', 'TableNo', 'PayerDiv'), 'unique' => 1)
		),
 ...
 */
	public $records = array(
		array(
			...
			'SalaryUnitPerDay' => 1,
			'registered_date' => '2013-06-17 23:49:01',
			'registered_by' => 'Lorem ip',
			'updated_date' => '2013-06-17 23:49:01',
			'updated_by' => 'Lorem ip',
