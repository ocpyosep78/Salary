<?php
/**
 * QmGimukyoikuTokubetsuFixture
 *
 */
class QmGimukyoikuTokubetsuFixture extends CakeTestFixture {
 ...
 * @var string
 */
	public $table = 'qm_gimukyoiku_tokubetsu';
 ...
 */
	public $fields = array(
		...
		'SalaryClass' => array('type' => 'string', 'null' => false, 'default' => null, 'length' => 2, 'key' => 'primary', 'collate' => 'utf8_general_ci', 'comment' => '給', 'charset' => 'utf8'),
		...
		'indexes' => array(
			'PRIMARY' => array('column' => array('RevYM', 'SalaryTable', 'SalaryClass', 'SalaryGrade'), 'unique' => 1)
		),
 ...
 */
	public $records = array(
		array(
			...
			'SalaryGrade' => 'L',
			'Payments' => 1,
			'registered_date' => '2013-06-17 23:32:42',
			'registered_by' => 'Lorem ip',
			'updated_date' => '2013-06-17 23:32:42',
			'updated_by' => 'Lorem ip',
