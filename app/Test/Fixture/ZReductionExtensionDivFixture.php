<?php
/**
 * ZReductionExtensionDivFixture
 *
 */
class ZReductionExtensionDivFixture extends CakeTestFixture {
 ...
 * @var string
 */
	public $table = 'z_reduction_extension_div';
 ...
 */
	public $fields = array(
		...
		'NAME' => array('type' => 'string', 'null' => true, 'default' => null, 'length' => 8, 'collate' => 'utf8_general_ci', 'comment' => '名称 : 名称', 'charset' => 'utf8'),
 ...
 */
	public $records = array(
		array(
			...
			'NAME' => 'Lorem ',
			'RegDate' => '2013-06-18 00:05:32',
			'RegisteredBy' => 'Lorem ip',
			'RegPgID' => 'Lorem ip',
			'UpdateDate' => '2013-06-18 00:05:32',
			'UpdateBy' => 'Lorem ip',
