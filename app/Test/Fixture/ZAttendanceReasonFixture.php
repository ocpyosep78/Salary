<?php
/**
 * ZAttendanceReasonFixture
 *
 */
class ZAttendanceReasonFixture extends CakeTestFixture {
 ...
 * @var string
 */
	public $table = 'z_attendance_reason';
 ...
 */
	public $fields = array(
		'ID' => array('type' => 'string', 'null' => false, 'default' => null, 'length' => 4, 'key' => 'primary', 'collate' => 'utf8_general_ci', 'comment' => '区分 : 区分', 'charset' => 'utf8'),
		'NAME' => array('type' => 'string', 'null' => true, 'default' => null, 'length' => 16, 'collate' => 'utf8_general_ci', 'comment' => '名称 : 名称', 'charset' => 'utf8'),
 ...
 */
	public $records = array(
		array(
			'ID' => 'Lo',
			'NAME' => 'Lorem ipsum do',
			'RegDate' => '2013-06-18 00:03:01',
			'RegisteredBy' => 'Lorem ip',
			'RegPgID' => 'Lorem ip',
			'UpdateDate' => '2013-06-18 00:03:01',
			'UpdateBy' => 'Lorem ip',
