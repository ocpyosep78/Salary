<?php
/**
 * QmHenkangoKamokuFixture
 *
 */
class QmHenkangoKamokuFixture extends CakeTestFixture {
 ...
 * @var string
 */
	public $table = 'qm_henkango_kamoku';
 ...
 */
	public $fields = array(
		...
		'BeforeAccountCD' => array('type' => 'string', 'null' => false, 'length' => 12, 'key' => 'primary', 'collate' => 'utf8_general_ci', 'comment' => '変換前科目CD', 'charset' => 'utf8'),
		...
		'indexes' => array(
			'PRIMARY' => array('column' => array('RevYM', 'AllowanceCD', 'BeforeAccountCD'), 'unique' => 1)
		),
 ...
 */
	public $records = array(
		array(
			'RevYM' => '2013-06-17',
			'AllowanceCD' => 'Lore',
			'BeforeAccountCD' => 'Lorem ipsu',
			'AfterAccountCD' => 'Lorem ipsu',
			'registered_date' => '2013-06-17 23:32:49',
			'registered_by' => 'Lorem ip',
			'updated_date' => '2013-06-17 23:32:49',
			'updated_by' => 'Lorem ip',
