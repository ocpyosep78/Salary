<?php
/**
 * QmSiharaishaParentFixture
 *
 */
class QmSiharaishaParentFixture extends CakeTestFixture {
 ...
 * @var string
 */
	public $table = 'qm_siharaisha_parent';
 ...
 */
	public $fields = array(
		...
		'AssignOrgCD' => array('type' => 'string', 'null' => false, 'default' => null, 'length' => 2, 'collate' => 'utf8_general_ci', 'comment' => '機関CD', 'charset' => 'utf8'),
		...
		'indexes' => array(
			'PRIMARY' => array('column' => array('RevYM', 'PayerDiv', 'SeqNo'), 'unique' => 1)
		),
 ...
 */
	public $records = array(
		array(
			...
			'SeqNo' => 1,
			'AssignOrgCD' => '',
			'registered_date' => '2013-06-17 23:40:30',
			'registered_by' => 'Lorem ip',
			'updated_date' => '2013-06-17 23:40:30',
			'updated_by' => 'Lorem ip',
