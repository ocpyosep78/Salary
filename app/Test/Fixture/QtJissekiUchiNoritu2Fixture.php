<?php
/**
 * QtJissekiUchiNoritu2Fixture
 *
 */
class QtJissekiUchiNoritu2Fixture extends CakeTestFixture {
 ...
 * @var string
 */
	public $table = 'qt_jisseki_uchi_noritu2';
 ...
 */
	public $records = array(
		array(
			...
			'AllowDetailCD1' => 'Lo',
			'EfficiencyWagesAmount1' => 1,
			'AllowDetailCD2' => 'Lo',
			'EfficiencyWagesAmount2' => 1,
			'AllowDetailCD3' => 'Lo',
			'EfficiencyWagesAmount3' => 1,
			'AllowDetailCD4' => 'Lo',
			'EfficiencyWagesAmount4' => 1,
			'AllowDetailCD5' => 'Lo',
			'EfficiencyWagesAmount5' => 1,
			'AllowDetailCD6' => 'Lo',
			'EfficiencyWagesAmount6' => 1,
			'AllowDetailCD7' => 'Lo',
			'EfficiencyWagesAmount7' => 1,
			'AllowDetailCD8' => 'Lo',
			'EfficiencyWagesAmount8' => 1,
			'AllowDetailCD9' => 'Lo',
			'EfficiencyWagesAmount9' => 1,
			'AllowDetailCD10' => 'Lo',
			'EfficiencyWagesAmount10' => 1,
			'StatusDiv' => 'Lorem ipsum dolor sit ame',
			'registered_date' => '2013-06-17 23:47:35',
			'registered_by' => 'Lorem ip',
			'updated_date' => '2013-06-17 23:47:35',
			'updated_by' => 'Lorem ip',
