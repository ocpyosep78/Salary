...
/**
 * QtMeisaiUchiKantoku Model
 *
 */
class QtMeisaiUchiKantoku extends AppModel {
 ...
 */
	public $useTable = 'qt_meisai_uchi_kantoku';
 ...
 */
	 ...
	 * @return 検索結果レコード
	 */
	public function findMeisaiUchiKantoku($paidYm, $empNo, $paidDiv, $payerDiv) {
