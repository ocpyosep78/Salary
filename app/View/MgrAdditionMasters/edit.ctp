...
<?php echo $this->Form->create('MgrAdditionMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit Mgr Addition Master'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MgrAdditionMaster.RevYM')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MgrAdditionMaster.RevYM'))); ?></li>
