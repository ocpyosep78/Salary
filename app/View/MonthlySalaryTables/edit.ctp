...
<?php echo $this->Form->create('MonthlySalaryTable'); ?>
	<fieldset>
		<legend><?php echo __('Edit Monthly Salary Table'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MonthlySalaryTable.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MonthlySalaryTable.id'))); ?></li>
