...
<?php echo $this->Form->create('FloorMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit Floor Master'); ?></legend>
	<?php
		echo $this->Form->input('FloorCD');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FloorMaster.FloorCD')), null, __('Are you sure you want to delete # %s?', $this->Form->value('FloorMaster.FloorCD'))); ?></li>
