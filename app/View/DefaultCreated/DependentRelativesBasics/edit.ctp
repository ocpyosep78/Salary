...
<?php echo $this->Form->create('DependentRelativesBasic'); ?>
	<fieldset>
		<legend><?php echo __('Edit Dependent Relatives Basic'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DependentRelativesBasic.ID')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DependentRelativesBasic.ID'))); ?></li>
