...
<?php echo $this->Form->create('MgrPassDivMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit Mgr Pass Div Master'); ?></legend>
	<?php
		echo $this->Form->input('MgrPassDiv');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MgrPassDivMaster.MgrPassDiv')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MgrPassDivMaster.MgrPassDiv'))); ?></li>
