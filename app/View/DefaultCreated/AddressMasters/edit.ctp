...
<?php echo $this->Form->create('AddressMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit Address Master'); ?></legend>
	<?php
		echo $this->Form->input('AddressMasterNo');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AddressMaster.AddressMasterNo')), null, __('Are you sure you want to delete # %s?', $this->Form->value('AddressMaster.AddressMasterNo'))); ?></li>
