...
<?php echo $this->Form->create('PromoSelParamMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit Promo Sel Param Master'); ?></legend>
	<?php
		echo $this->Form->input('PromoSelParamID');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PromoSelParamMaster.PromoSelParamID')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PromoSelParamMaster.PromoSelParamID'))); ?></li>
