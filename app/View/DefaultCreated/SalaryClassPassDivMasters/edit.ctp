...
<?php echo $this->Form->create('SalaryClassPassDivMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit Salary Class Pass Div Master'); ?></legend>
	<?php
		echo $this->Form->input('SalaryClassPassDiv');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SalaryClassPassDivMaster.SalaryClassPassDiv')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SalaryClassPassDivMaster.SalaryClassPassDiv'))); ?></li>
