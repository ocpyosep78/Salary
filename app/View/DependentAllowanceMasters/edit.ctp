...
<?php echo $this->Form->create('DependentAllowanceMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit Dependent Allowance Master'); ?></legend>
	<?php
		echo $this->Form->input('DependentAllowanceMasterID');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DependentAllowanceMaster.DependentAllowanceMasterID')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DependentAllowanceMaster.DependentAllowanceMasterID'))); ?></li>
