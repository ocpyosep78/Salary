...
<?php echo $this->Form->create('LGovMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit L Gov Master'); ?></legend>
	<?php
		echo $this->Form->input('LGovMasterNo');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('LGovMaster.LGovMasterNo')), null, __('Are you sure you want to delete # %s?', $this->Form->value('LGovMaster.LGovMasterNo'))); ?></li>
