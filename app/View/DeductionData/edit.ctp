...
<?php echo $this->Form->create('DeductionDatum'); ?>
	<fieldset>
		<legend><?php echo __('Edit Deduction Datum'); ?></legend>
	<?php
		echo $this->Form->input('DeductionYm');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DeductionDatum.DeductionYm')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DeductionDatum.DeductionYm'))); ?></li>
