...
<?php echo $this->Form->create('HourlySalaryCalcCondMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit Hourly Salary Calc Cond Master'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('HourlySalaryCalcCondMaster.FiscalYear')), null, __('Are you sure you want to delete # %s?', $this->Form->value('HourlySalaryCalcCondMaster.FiscalYear'))); ?></li>
