...
<?php echo $this->Form->create('JobCategoryMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit Job Category Master'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('JobCategoryMaster.JobDutyCD')), null, __('Are you sure you want to delete # %s?', $this->Form->value('JobCategoryMaster.JobDutyCD'))); ?></li>
