...
<?php echo $this->Form->create('DependentRelativesAllowance'); ?>
	<fieldset>
		<legend><?php echo __('Edit Dependent Relatives Allowance'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DependentRelativesAllowance.ID')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DependentRelativesAllowance.ID'))); ?></li>
