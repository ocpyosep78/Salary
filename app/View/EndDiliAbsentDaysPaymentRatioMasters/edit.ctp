...
<?php echo $this->Form->create('EndDiliAbsentDaysPaymentRatioMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit End Dili Absent Days Payment Ratio Master'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EndDiliAbsentDaysPaymentRatioMaster.RevYM')), null, __('Are you sure you want to delete # %s?', $this->Form->value('EndDiliAbsentDaysPaymentRatioMaster.RevYM'))); ?></li>
