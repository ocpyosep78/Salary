...
<?php echo $this->Form->create('SpRiseCanDatum'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sp Rise Can Datum'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SpRiseCanDatum.ID')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SpRiseCanDatum.ID'))); ?></li>
