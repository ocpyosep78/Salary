...
<?php echo $this->Form->create('JobDutySalaryCombiMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit Job Duty Salary Combi Master'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('JobDutySalaryCombiMaster.JobDutyCD')), null, __('Are you sure you want to delete # %s?', $this->Form->value('JobDutySalaryCombiMaster.JobDutyCD'))); ?></li>
