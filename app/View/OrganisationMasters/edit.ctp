...
<?php echo $this->Form->create('OrganisationMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit Organisation Master'); ?></legend>
	<?php
		echo $this->Form->input('OrgCD');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('OrganisationMaster.OrgCD')), null, __('Are you sure you want to delete # %s?', $this->Form->value('OrganisationMaster.OrgCD'))); ?></li>
